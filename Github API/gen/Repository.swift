...
public final class Repository: NSCoding {
  ...
  public required init(json: JSON) {
    ...
    parent = Parent(json: json[SerializationKeys.parent])
    ...
    organization = Organization(json: json[SerializationKeys.organization])
  ...
  public func dictionaryRepresentation() -> [String: Any] {
    ...
    if let value = parent { dictionary[SerializationKeys.parent] = value.dictionaryRepresentation() }
    ...
    if let value = organization { dictionary[SerializationKeys.organization] = value.dictionaryRepresentation() }
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.parent = aDecoder.decodeObject(forKey: SerializationKeys.parent) as? Parent
    ...
    self.organization = aDecoder.decodeObject(forKey: SerializationKeys.organization) as? Organization
  ...
  public func encode(with aCoder: NSCoder) {
    ...
    aCoder.encode(organization, forKey: SerializationKeys.organization)
