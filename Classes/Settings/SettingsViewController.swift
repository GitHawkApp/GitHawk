...
GitHubSessionListener {
    ...
    @IBOutlet weak var openExternalLinksLabel: SettingsLabel!
    ...
    override func viewDidLoad() {
        ...
        openExternalLinksSwitch.isOn = UserDefaults.standard.isNeedOpenExternalLinksInSafari
    ...
    @IBAction private func onOpenExternalLinks(_ sender: Any) {
        UserDefaults.standard.isNeedOpenExternalLinksInSafari = openExternalLinksSwitch.isOn
    }
